...
const subtractDateTime = (num = 1, time = 'd', format = 'DD/MM/YYYY') => momentDateToString(moment().subtract(num, time), format)
...
export const fdtfM3 = (dt, mx = 'm3b') => {
  if (mx?.toLowerCase() === 'm3a') return `${fdtfM1(dt, 'm1b')} ${fdtfM2(dt, 'm2e')}`
